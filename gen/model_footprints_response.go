...
func (o *FootprintsResponse) GetNextPageValue() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *FootprintsResponse) GetNextPageValueOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FootprintsResponse) SetNextPageValue(v int64) {
