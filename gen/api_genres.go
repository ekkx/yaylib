...
func (r ApiListGenresRequest) Execute() (*GenresResponse, *http.Response, error) {
...
*/
func (a *GenresAPIService) ListGenres(ctx context.Context) ApiListGenresRequest {
	return ApiListGenresRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *GenresAPIService) ListGenresExecute(r ApiListGenresRequest) (*GenresResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GenresResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GenresAPIService.ListGenres")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/genres"
