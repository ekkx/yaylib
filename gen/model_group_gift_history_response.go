...
func (o *GroupGiftHistoryResponse) GetNextPageValue() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GroupGiftHistoryResponse) GetNextPageValueOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GroupGiftHistoryResponse) SetNextPageValue(v int64) {
