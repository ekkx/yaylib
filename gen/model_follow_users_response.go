...
func (o *FollowUsersResponse) GetNextPageValue() int64 {
...
func (o *FollowUsersResponse) GetNextPageValueOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FollowUsersResponse) SetNextPageValue(v int64) {
