...
class ConversationsApi:
    ...
    async def get_conversation(
        ...
        from_post_id: Optional[StrictInt] = None,
    ...
    def _get_conversation_serialize(
        ...
        if from_post_id is not None:
            ...
            _query_params.append(('from_post_id', from_post_id))
    ...
    async def get_root_posts(
        ...
        _param = self._get_root_posts_serialize(
            ids=ids,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_root_posts_with_http_info(
        self,
        ids: Optional[List[StrictInt]] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_root_posts_without_preload_content(
        self,
        ids: Optional[List[StrictInt]] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_root_posts_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/conversations/root_posts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
