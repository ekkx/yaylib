...
from yaylib.api_response import ApiResponse, T as ApiResponseT
import yaylib.models
from yaylib import rest
from yaylib.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    the methods and models for each application are generated from the API schema
    templates.
    ...
    def __init__(
        ...
        self.user_agent = 'yay-api/0.1.0/python'
    ...
    def sanitize_for_serialization(self, obj):
        ...
        If obj is an API model, return the properties dict.
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(yaylib.models, klass)
