...
class CreateQuotaResponse(BaseModel):
    ...
    CreateQuotaResponse
    """ # noqa: E501
    create: Optional[CreateGroupQuota] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateQuotaResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateQuotaResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "create": CreateGroupQuota.from_dict(obj["create"]) if obj.get("create") is not None else None
        })
        return _obj
