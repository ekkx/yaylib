...
class Sticker(BaseModel):
    ...
    sticker_pack_id: Optional[StrictInt] = None
    url: Optional[StrictStr] = None
    width: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["extension", "height", "id", "sticker_pack_id", "url", "width"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sticker_pack_id (nullable) is None
        # and model_fields_set contains the field
        if self.sticker_pack_id is None and "sticker_pack_id" in self.model_fields_set:
            _dict['sticker_pack_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "sticker_pack_id": obj.get("sticker_pack_id"),
            "url": obj.get("url"),
            "width": obj.get("width")
        })
        return _obj
