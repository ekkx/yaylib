...
class EmplTransaction(BaseModel):
    """
    EmplTransaction
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["amount", "id", "occurred_at", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmplTransaction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmplTransaction from a dict"""
        if obj is None:
            return None
