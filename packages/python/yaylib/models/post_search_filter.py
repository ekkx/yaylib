...
class PostSearchFilter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["message_id", "title_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostSearchFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostSearchFilter from a dict"""
        if obj is None:
            return None
