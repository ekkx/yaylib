...
class UsersByTimestampResponse(BaseModel):
    """
    UsersByTimestampResponse
    """ # noqa: E501
    last_timestamp: Optional[StrictInt] = None
    users: Optional[List[RealmUser]] = None
    __properties: ClassVar[List[str]] = ["last_timestamp", "users"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UsersByTimestampResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UsersByTimestampResponse from a dict"""
        if obj is None:
            return None
