...
class ModelShareable(BaseModel):
    """
    ModelShareable
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["group", "post", "thread"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelShareable from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelShareable from a dict"""
        if obj is None:
            return None
...
ModelShareable.model_rebuild(raise_errors=False)
