...
class InvitedUserDetailsDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "nickname", "profile_icon"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvitedUserDetailsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvitedUserDetailsDTO from a dict"""
        if obj is None:
            return None
