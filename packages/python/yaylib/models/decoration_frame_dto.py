...
class DecorationFrameDTO(BaseModel):
    """
    DecorationFrameDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["current", "frame", "frame_thumbnail", "frame_type", "id", "owned", "price", "vip_only"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DecorationFrameDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DecorationFrameDTO from a dict"""
        if obj is None:
            return None
