...
class ModelMessageTag(BaseModel):
    """
    ModelMessageTag
    """ # noqa: E501
    ...
    type: Optional[MessageTagType] = None
    user_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["end_at", "length", "offset", "type", "user_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelMessageTag from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelMessageTag from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "type": MessageTagType.from_dict(obj["type"]) if obj.get("type") is not None else None,
