...
class BlockedUsersResponse(BaseModel):
    ...
    """ # noqa: E501
    blocked_count: Optional[StrictInt] = None
    last_id: Optional[StrictInt] = None
    users: Optional[List[RealmUser]] = None
    __properties: ClassVar[List[str]] = ["blocked_count", "last_id", "users"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BlockedUsersResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.users:
            ...
            _dict['users'] = _items
        # set to None if blocked_count (nullable) is None
        # and model_fields_set contains the field
        if self.blocked_count is None and "blocked_count" in self.model_fields_set:
            _dict['blocked_count'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BlockedUsersResponse from a dict"""
        if obj is None:
            return None
