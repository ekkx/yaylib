...
class DailyQuest(BaseModel):
    ...
    target_duration_seconds: Optional[StrictInt] = None
    timestamp: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["calculated", "spent_duration_seconds", "target_duration_seconds", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DailyQuest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if target_duration_seconds (nullable) is None
        # and model_fields_set contains the field
        if self.target_duration_seconds is None and "target_duration_seconds" in self.model_fields_set:
            _dict['target_duration_seconds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DailyQuest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "target_duration_seconds": obj.get("target_duration_seconds"),
