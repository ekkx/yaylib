...
class NftCollectionDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contract_address", "image", "media_type", "name", "priority", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NftCollectionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NftCollectionDTO from a dict"""
        if obj is None:
            return None
