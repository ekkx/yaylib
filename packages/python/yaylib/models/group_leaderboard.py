...
class GroupLeaderboard(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["group", "ranking", "total_scores"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupLeaderboard from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupLeaderboard from a dict"""
        if obj is None:
            return None
