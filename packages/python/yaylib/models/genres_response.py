...
class GenresResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenresResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenresResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "genres": [RealmGenre.from_dict(_item) for _item in obj["genres"]] if obj.get("genres") is not None else None,
