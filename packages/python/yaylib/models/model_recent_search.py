...
class ModelRecentSearch(BaseModel):
    """
    ModelRecentSearch
    """ # noqa: E501
    hashtag: Optional[ModelPostTag] = None
    id: Optional[StrictInt] = None
    keyword: Optional[StrictStr] = None
    type: Optional[RecentSearchType] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelRecentSearch from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelRecentSearch from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "hashtag": ModelPostTag.from_dict(obj["hashtag"]) if obj.get("hashtag") is not None else None,
            "id": obj.get("id"),
            "keyword": obj.get("keyword"),
            "type": RecentSearchType.from_dict(obj["type"]) if obj.get("type") is not None else None,
