...
class ChatRoomResponse(BaseModel):
    ...
    ChatRoomResponse
    """ # noqa: E501
    chat: Optional[RealmChatRoom] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatRoomResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatRoomResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "chat": RealmChatRoom.from_dict(obj["chat"]) if obj.get("chat") is not None else None
        })
        return _obj
