...
class StateChanges(BaseModel):
    ...
    energy: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["attack", "defense", "energy", "luck", "power", "speed", "stamina", "technique"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if attack (nullable) is None
        # and model_fields_set contains the field
        if self.attack is None and "attack" in self.model_fields_set:
            _dict['attack'] = None
