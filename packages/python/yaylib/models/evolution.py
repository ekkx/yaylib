...
class Evolution(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["grade", "level", "pal_image_url", "pal_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Evolution from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Evolution from a dict"""
        if obj is None:
            return None
