...
class ModelPost(BaseModel):
    ...
    edited_at_seconds: Optional[StrictInt] = None
    font_size: Optional[StrictInt] = None
    game_title: Optional[StrictStr] = None
    gifts: Optional[List[PostGift]] = None
    group: Optional[ModelGroup] = None
    group_id: Optional[StrictInt] = None
    group_user_title: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    in_reply_to: Optional[StrictInt] = None
    in_reply_to_post: Optional[ModelPost] = None
    in_reply_to_post_count: Optional[StrictInt] = None
    is_edited: Optional[StrictBool] = None
    ...
    is_id_fake: Optional[StrictBool] = None
    ...
    is_repostable: Optional[StrictBool] = None
    is_reposted: Optional[StrictBool] = None
    is_root_of_conversation: Optional[StrictBool] = None
    is_root_of_conversation_comment: Optional[StrictBool] = None
    likers: Optional[List[User]] = None
    likers_count: Optional[StrictInt] = None
    likes_count: Optional[StrictInt] = None
    mentions: Optional[List[User]] = None
    message_tags: Optional[List[ModelMessageTag]] = None
    post_type: Optional[Dict[str, Any]] = None
    reported_count: Optional[StrictInt] = None
    reposts_count: Optional[StrictInt] = None
    shareable: Optional[ModelShareable] = None
    shared_thread: Optional[ModelThreadInfo] = None
    shared_url: Optional[ModelSharedUrl] = None
    should_show_original_source: Optional[StrictBool] = None
    should_show_see_more_conversation: Optional[StrictBool] = None
    survey: Optional[ModelSurvey] = None
    tag: Optional[StrictStr] = None
    text: Optional[StrictStr] = None
    thread: Optional[ModelThreadInfo] = None
    thread_id: Optional[StrictInt] = None
    total_gifts_count: Optional[StrictInt] = None
    updated_at_seconds: Optional[StrictInt] = None
    user: Optional[User] = None
    videos: Optional[List[ModelVideo]] = None
    __properties: ClassVar[List[str]] = ["attachment", "attachment_2", "attachment_2_thumbnail", "attachment_3", "attachment_3_thumbnail", "attachment_4", "attachment_4_thumbnail", "attachment_5", "attachment_5_thumbnail", "attachment_6", "attachment_6_thumbnail", "attachment_7", "attachment_7_thumbnail", "attachment_8", "attachment_8_thumbnail", "attachment_9", "attachment_9_thumbnail", "attachment_thumbnail", "category_id", "color", "conference_call", "conversation_id", "created_at_seconds", "edited_at_seconds", "font_size", "game_title", "gifts", "group", "group_id", "group_user_title", "id", "in_reply_to", "in_reply_to_post", "in_reply_to_post_count", "is_edited", "is_fail_to_send", "is_group", "is_highlighted", "is_hot", "is_id_fake", "is_liked", "is_muted", "is_pinned", "is_recommended", "is_repostable", "is_reposted", "is_root_of_conversation", "is_root_of_conversation_comment", "likers", "likers_count", "likes_count", "mentions", "message_tags", "post_type", "reported_count", "reposts_count", "shareable", "shared_thread", "shared_url", "should_show_original_source", "should_show_see_more_conversation", "survey", "tag", "text", "thread", "thread_id", "total_gifts_count", "updated_at_seconds", "user", "videos"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if edited_at_seconds (nullable) is None
        # and model_fields_set contains the field
        if self.edited_at_seconds is None and "edited_at_seconds" in self.model_fields_set:
            _dict['edited_at_seconds'] = None
        ...
        # set to None if game_title (nullable) is None
        # and model_fields_set contains the field
        if self.game_title is None and "game_title" in self.model_fields_set:
            _dict['game_title'] = None
        ...
        # set to None if group_user_title (nullable) is None
        # and model_fields_set contains the field
        if self.group_user_title is None and "group_user_title" in self.model_fields_set:
            _dict['group_user_title'] = None
        ...
        # and model_fields_set contains the field
        if self.is_edited is None and "is_edited" in self.model_fields_set:
        ...
        # set to None if is_highlighted (nullable) is None
        # and model_fields_set contains the field
        if self.is_highlighted is None and "is_highlighted" in self.model_fields_set:
            _dict['is_highlighted'] = None

        # set to None if is_hot (nullable) is None
        # and model_fields_set contains the field
        if self.is_hot is None and "is_hot" in self.model_fields_set:
            _dict['is_hot'] = None

        # set to None if is_id_fake (nullable) is None
        # and model_fields_set contains the field
        if self.is_id_fake is None and "is_id_fake" in self.model_fields_set:
            _dict['is_id_fake'] = None

        # set to None if is_liked (nullable) is None
        # and model_fields_set contains the field
        if self.is_liked is None and "is_liked" in self.model_fields_set:
            _dict['is_liked'] = None
        ...
        # set to None if is_recommended (nullable) is None
        # and model_fields_set contains the field
        if self.is_recommended is None and "is_recommended" in self.model_fields_set:
            _dict['is_recommended'] = None

        # set to None if is_repostable (nullable) is None
        # and model_fields_set contains the field
        if self.is_repostable is None and "is_repostable" in self.model_fields_set:
            _dict['is_repostable'] = None

        # set to None if is_reposted (nullable) is None
        # and model_fields_set contains the field
        if self.is_reposted is None and "is_reposted" in self.model_fields_set:
            _dict['is_reposted'] = None

        # set to None if is_root_of_conversation (nullable) is None
        # and model_fields_set contains the field
        if self.is_root_of_conversation is None and "is_root_of_conversation" in self.model_fields_set:
            _dict['is_root_of_conversation'] = None

        # set to None if is_root_of_conversation_comment (nullable) is None
        # and model_fields_set contains the field
        if self.is_root_of_conversation_comment is None and "is_root_of_conversation_comment" in self.model_fields_set:
            _dict['is_root_of_conversation_comment'] = None
        ...
        # set to None if should_show_original_source (nullable) is None
        # and model_fields_set contains the field
        if self.should_show_original_source is None and "should_show_original_source" in self.model_fields_set:
            _dict['should_show_original_source'] = None

        # set to None if should_show_see_more_conversation (nullable) is None
        # and model_fields_set contains the field
        if self.should_show_see_more_conversation is None and "should_show_see_more_conversation" in self.model_fields_set:
            _dict['should_show_see_more_conversation'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "edited_at_seconds": obj.get("edited_at_seconds"),
            "font_size": obj.get("font_size"),
            "game_title": obj.get("game_title"),
            "gifts": [PostGift.from_dict(_item) for _item in obj["gifts"]] if obj.get("gifts") is not None else None,
            "group": ModelGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "group_id": obj.get("group_id"),
            "group_user_title": obj.get("group_user_title"),
            "id": obj.get("id"),
            "in_reply_to": obj.get("in_reply_to"),
            "in_reply_to_post": ModelPost.from_dict(obj["in_reply_to_post"]) if obj.get("in_reply_to_post") is not None else None,
            ...
            "is_hot": obj.get("is_hot"),
            "is_id_fake": obj.get("is_id_fake"),
            "is_liked": obj.get("is_liked"),
            "is_muted": obj.get("is_muted"),
            "is_pinned": obj.get("is_pinned"),
            "is_recommended": obj.get("is_recommended"),
            "is_repostable": obj.get("is_repostable"),
            "is_reposted": obj.get("is_reposted"),
            "is_root_of_conversation": obj.get("is_root_of_conversation"),
            "is_root_of_conversation_comment": obj.get("is_root_of_conversation_comment"),
            "likers": [User.from_dict(_item) for _item in obj["likers"]] if obj.get("likers") is not None else None,
            "likers_count": obj.get("likers_count"),
            "likes_count": obj.get("likes_count"),
            "mentions": [User.from_dict(_item) for _item in obj["mentions"]] if obj.get("mentions") is not None else None,
            "message_tags": [ModelMessageTag.from_dict(_item) for _item in obj["message_tags"]] if obj.get("message_tags") is not None else None,
            "post_type": obj.get("post_type"),
            "reported_count": obj.get("reported_count"),
            "reposts_count": obj.get("reposts_count"),
            "shareable": ModelShareable.from_dict(obj["shareable"]) if obj.get("shareable") is not None else None,
            "shared_thread": ModelThreadInfo.from_dict(obj["shared_thread"]) if obj.get("shared_thread") is not None else None,
            "shared_url": ModelSharedUrl.from_dict(obj["shared_url"]) if obj.get("shared_url") is not None else None,
            "should_show_original_source": obj.get("should_show_original_source"),
            "should_show_see_more_conversation": obj.get("should_show_see_more_conversation"),
            "survey": ModelSurvey.from_dict(obj["survey"]) if obj.get("survey") is not None else None,
            "tag": obj.get("tag"),
            "text": obj.get("text"),
            "thread": ModelThreadInfo.from_dict(obj["thread"]) if obj.get("thread") is not None else None,
            "thread_id": obj.get("thread_id"),
            "total_gifts_count": obj.get("total_gifts_count"),
            "updated_at_seconds": obj.get("updated_at_seconds"),
            "user": User.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "videos": [ModelVideo.from_dict(_item) for _item in obj["videos"]] if obj.get("videos") is not None else None
        })
        return _obj
...
ModelPost.model_rebuild(raise_errors=False)
