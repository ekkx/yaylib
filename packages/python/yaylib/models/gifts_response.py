...
class GiftsResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GiftsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GiftsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "gifts": [RealmGift.from_dict(_item) for _item in obj["gifts"]] if obj.get("gifts") is not None else None,
