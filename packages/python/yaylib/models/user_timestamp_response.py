...
class UserTimestampResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["country", "ip_address", "time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserTimestampResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserTimestampResponse from a dict"""
        if obj is None:
            return None
