...
class Details(BaseModel):
    ...
    transaction_fee: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["chain_id", "error", "max_token_amount", "min_token_amount", "token_out_address", "token_out_amount", "token_symbol", "transaction_fee"]
