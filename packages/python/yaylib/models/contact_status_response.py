...
class ContactStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    contacts: Optional[Dict[str, ContactStatus]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContactStatusResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContactStatusResponse from a dict"""
        if obj is None:
            return None
