...
class Pal(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["current_level", "fatigue_level", "nickname", "overall_strength", "profile_image", "rank", "token_id", "tribe", "type", "win_rate", "winning_streak"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Pal from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Pal from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "profile_image": ProfileImage.from_dict(obj["profile_image"]) if obj.get("profile_image") is not None else None,
            "rank": obj.get("rank"),
