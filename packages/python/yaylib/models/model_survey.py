...
class ModelSurvey(BaseModel):
    """
    ModelSurvey
    """ # noqa: E501
    choices: Optional[List[SurveyChoice]] = None
    id: Optional[StrictInt] = None
    is_voted: Optional[StrictBool] = None
    votes_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["choices", "id", "is_voted", "votes_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelSurvey from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if is_voted (nullable) is None
        # and model_fields_set contains the field
        if self.is_voted is None and "is_voted" in self.model_fields_set:
            _dict['is_voted'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelSurvey from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "choices": [SurveyChoice.from_dict(_item) for _item in obj["choices"]] if obj.get("choices") is not None else None,
            "id": obj.get("id"),
            "is_voted": obj.get("is_voted"),
