...
class Web3WalletTransactionHistoryAssetInfo(BaseModel):
    """
    Web3WalletTransactionHistoryAssetInfo
    """ # noqa: E501
    image_url: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    token_id: Optional[StrictStr] = None
    video_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["image_url", "name", "token_id", "video_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Web3WalletTransactionHistoryAssetInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Web3WalletTransactionHistoryAssetInfo from a dict"""
        if obj is None:
            return None
