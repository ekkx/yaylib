...
class ModelSnsInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["biography", "gender", "nickname", "profile_image", "type", "uid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelSnsInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelSnsInfo from a dict"""
        if obj is None:
            return None
