...
class MissionDTO(BaseModel):
    ...
    reward_points: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["action", "id", "mission_type", "progress", "required_actions_count", "reward_points"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MissionDTO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if reward_points (nullable) is None
        # and model_fields_set contains the field
        if self.reward_points is None and "reward_points" in self.model_fields_set:
            _dict['reward_points'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MissionDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "progress": ProgressDTO.from_dict(obj["progress"]) if obj.get("progress") is not None else None,
            "required_actions_count": obj.get("required_actions_count"),
            "reward_points": obj.get("reward_points")
        })
        return _obj
