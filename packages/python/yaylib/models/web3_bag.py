...
class Web3Bag(BaseModel):
    """
    Web3Bag
    """ # noqa: E501
    empl: Optional[Dict[str, Any]] = None
    pals_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["empl", "pals_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Web3Bag from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Web3Bag from a dict"""
        if obj is None:
            return None
