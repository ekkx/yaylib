...
class ChatRoom(BaseModel):
    ...
    is_notification_on: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["background", "id", "is_group", "is_notification_on", "is_pinned", "is_request", "last_message", "members", "name", "owner", "unread_count", "updated_at_millis"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if is_notification_on (nullable) is None
        # and model_fields_set contains the field
        if self.is_notification_on is None and "is_notification_on" in self.model_fields_set:
            _dict['is_notification_on'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_notification_on": obj.get("is_notification_on"),
