...
class MaxAttribute(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["luck", "power", "speed", "stamina", "technique"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MaxAttribute from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MaxAttribute from a dict"""
        if obj is None:
            return None
