...
class LoginUpdateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["access_token", "expires_in", "refresh_token", "user_id", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoginUpdateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoginUpdateResponse from a dict"""
        if obj is None:
            return None
