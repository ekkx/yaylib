...
class GroupMuteUsersResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["group_users", "next_cursor", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupMuteUsersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupMuteUsersResponse from a dict"""
        if obj is None:
            return None
