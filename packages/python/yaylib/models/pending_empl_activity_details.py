...
class PendingEmplActivityDetails(BaseModel):
    """
    PendingEmplActivityDetails
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["max_token_amount", "min_token_amount", "token_out_address", "transaction_fee"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PendingEmplActivityDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PendingEmplActivityDetails from a dict"""
        if obj is None:
            return None
