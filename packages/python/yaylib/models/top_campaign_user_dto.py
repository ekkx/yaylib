...
class TopCampaignUserDTO(BaseModel):
    """
    TopCampaignUserDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["points", "ranking", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TopCampaignUserDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TopCampaignUserDTO from a dict"""
        if obj is None:
            return None
