...
class ProgressDTO(BaseModel):
    ...
    ProgressDTO
    """ # noqa: E501
    actions_count: Optional[StrictInt] = None
    completed_at: Optional[StrictInt] = None
    total_earned_points: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["actions_count", "completed_at", "total_earned_points"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if actions_count (nullable) is None
        # and model_fields_set contains the field
        if self.actions_count is None and "actions_count" in self.model_fields_set:
            _dict['actions_count'] = None
