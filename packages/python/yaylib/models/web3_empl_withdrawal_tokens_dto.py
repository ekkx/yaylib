...
class Web3EmplWithdrawalTokensDTO(BaseModel):
    """
    Web3EmplWithdrawalTokensDTO
    """ # noqa: E501
    tokens: Optional[List[Web3EmplWithdrawalTokenDTO]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Web3EmplWithdrawalTokensDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Web3EmplWithdrawalTokensDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tokens": [Web3EmplWithdrawalTokenDTO.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None
        })
        return _obj
