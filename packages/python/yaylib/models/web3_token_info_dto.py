...
class Web3TokenInfoDTO(BaseModel):
    """
    Web3TokenInfoDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["chain_id", "localized_urls", "symbol"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Web3TokenInfoDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Web3TokenInfoDTO from a dict"""
        if obj is None:
            return None
