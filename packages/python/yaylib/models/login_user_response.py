...
class LoginUserResponse(BaseModel):
    ...
    sns_info: Optional[SnsInfo] = None
    user_id: Optional[StrictInt] = None
    username: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["access_token", "expires_in", "is_new", "refresh_token", "sns_info", "user_id", "username"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sns_info
        if self.sns_info:
            _dict['sns_info'] = self.sns_info.to_dict()
        ...
        # set to None if sns_info (nullable) is None
        # and model_fields_set contains the field
        if self.sns_info is None and "sns_info" in self.model_fields_set:
            _dict['sns_info'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sns_info": SnsInfo.from_dict(obj["sns_info"]) if obj.get("sns_info") is not None else None,
