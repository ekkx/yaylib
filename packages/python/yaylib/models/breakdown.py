...
class Breakdown(BaseModel):
    ...
    original_points: Optional[StrictInt] = None
    special_mission: Optional[Union[StrictFloat, StrictInt]] = None
    vip_multiplier: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["activity", "original_points", "special_mission", "vip_multiplier"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if original_points (nullable) is None
        # and model_fields_set contains the field
        if self.original_points is None and "original_points" in self.model_fields_set:
            _dict['original_points'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "original_points": obj.get("original_points"),
