...
class SurveyChoice(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "label", "votes_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SurveyChoice from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SurveyChoice from a dict"""
        if obj is None:
            return None
