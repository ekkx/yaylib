...
class Web3WalletEmplExpiringList(BaseModel):
    """
    Web3WalletEmplExpiringList
    """ # noqa: E501
    regular_expiring: Optional[List[Web3WalletEmplExpiring]] = None
    rewarded_expiring: Optional[List[Web3WalletEmplExpiring]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Web3WalletEmplExpiringList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Web3WalletEmplExpiringList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "regular_expiring": [Web3WalletEmplExpiring.from_dict(_item) for _item in obj["regular_expiring"]] if obj.get("regular_expiring") is not None else None,
            "rewarded_expiring": [Web3WalletEmplExpiring.from_dict(_item) for _item in obj["rewarded_expiring"]] if obj.get("rewarded_expiring") is not None else None
        })
        return _obj
