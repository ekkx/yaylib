...
class UserMuted(BaseModel):
    """
    UserMuted
    """ # noqa: E501
    is_muted: Optional[StrictBool] = None
    user: Optional[User] = None
    __properties: ClassVar[List[str]] = ["is_muted", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserMuted from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserMuted from a dict"""
        if obj is None:
            return None
