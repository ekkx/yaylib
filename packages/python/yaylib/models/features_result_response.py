...
class FeaturesResultResponse(BaseModel):
    """
    FeaturesResultResponse
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FeaturesResultResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FeaturesResultResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "features": FeaturesDTO.from_dict(obj["features"]) if obj.get("features") is not None else None
        })
        return _obj
