...
class PostGift(BaseModel):
    """
    PostGift
    """ # noqa: E501
    count: Optional[StrictInt] = None
    gift: Optional[Gift] = None
    __properties: ClassVar[List[str]] = ["count", "gift"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostGift from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostGift from a dict"""
        if obj is None:
            return None
