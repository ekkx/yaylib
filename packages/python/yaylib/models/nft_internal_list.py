...
class NftInternalList(BaseModel):
    """
    NftInternalList
    """ # noqa: E501
    cursor: Optional[StrictStr] = None
    result: Optional[List[PalDTO]] = None
    total_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["cursor", "result", "total_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NftInternalList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NftInternalList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "result": [PalDTO.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
