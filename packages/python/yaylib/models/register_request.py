...
class RegisterRequest(BaseModel):
    ...
    RegisterRequest
    """ # noqa: E501
    signed_data_type: Optional[StrictStr] = None
    wallet_address: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["signed_data_type", "wallet_address"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if signed_data_type (nullable) is None
        # and model_fields_set contains the field
        if self.signed_data_type is None and "signed_data_type" in self.model_fields_set:
            _dict['signed_data_type'] = None
