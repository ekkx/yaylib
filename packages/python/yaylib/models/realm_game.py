...
class RealmGame(BaseModel):
    """
    RealmGame
    """ # noqa: E501
    icon_url: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    platform_details: Optional[RealmPlatformDetails] = None
    title: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["icon_url", "id", "platform_details", "title"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RealmGame from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RealmGame from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "platform_details": RealmPlatformDetails.from_dict(obj["platform_details"]) if obj.get("platform_details") is not None else None,
            "title": obj.get("title")
        })
        return _obj
