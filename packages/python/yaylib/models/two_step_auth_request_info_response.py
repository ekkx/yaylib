...
class TwoStepAuthRequestInfoResponse(BaseModel):
    """
    TwoStepAuthRequestInfoResponse
    """ # noqa: E501
    qr_code: Optional[StrictStr] = None
    secret: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["qr_code", "secret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TwoStepAuthRequestInfoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TwoStepAuthRequestInfoResponse from a dict"""
        if obj is None:
            return None
