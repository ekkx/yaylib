...
class Web3WalletBlockStoreItem(BaseModel):
    """
    Web3WalletBlockStoreItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["created_at_millis", "name", "private_key", "seed_phrase", "wallet_address"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Web3WalletBlockStoreItem from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if seed_phrase (nullable) is None
        # and model_fields_set contains the field
        if self.seed_phrase is None and "seed_phrase" in self.model_fields_set:
            _dict['seed_phrase'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Web3WalletBlockStoreItem from a dict"""
        if obj is None:
            return None
