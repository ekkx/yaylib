...
class BagDTO(BaseModel):
    """
    BagDTO
    """ # noqa: E501
    eggs_count: Optional[StrictInt] = None
    empl: Optional[EmplDTO] = None
    expiring_empl: Optional[StrictStr] = None
    pals_count: Optional[StrictInt] = None
    race_pal_available: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["eggs_count", "empl", "expiring_empl", "pals_count", "race_pal_available"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BagDTO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if expiring_empl (nullable) is None
        # and model_fields_set contains the field
        if self.expiring_empl is None and "expiring_empl" in self.model_fields_set:
            _dict['expiring_empl'] = None
        ...
        # set to None if race_pal_available (nullable) is None
        # and model_fields_set contains the field
        if self.race_pal_available is None and "race_pal_available" in self.model_fields_set:
            _dict['race_pal_available'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BagDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "expiring_empl": obj.get("expiring_empl"),
            "pals_count": obj.get("pals_count"),
            "race_pal_available": obj.get("race_pal_available")
        })
        return _obj
