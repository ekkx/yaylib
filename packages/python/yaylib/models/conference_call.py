...
class ConferenceCall(BaseModel):
    ...
    bump_params: Optional[BumpParams] = None
    call_type: Optional[StrictStr] = None
    conference_call_user_uuid: Optional[StrictStr] = None
    conference_call_users: Optional[List[User]] = None
    conference_call_users_role: Optional[List[ModelConferenceCallUserRole]] = None
    ...
    __properties: ClassVar[List[str]] = ["agora_channel", "agora_token", "anonymous_call_users_count", "bump_params", "call_type", "conference_call_user_uuid", "conference_call_users", "conference_call_users_role", "duration_seconds", "game", "genre", "group_id", "id", "is_active", "joinable_by", "max_participants", "post_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConferenceCall from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in conference_call_users_role (list)
        _items = []
        if self.conference_call_users_role:
            for _item_conference_call_users_role in self.conference_call_users_role:
                if _item_conference_call_users_role:
                    _items.append(_item_conference_call_users_role.to_dict())
            _dict['conference_call_users_role'] = _items
        ...
        # set to None if conference_call_user_uuid (nullable) is None
        # and model_fields_set contains the field
        if self.conference_call_user_uuid is None and "conference_call_user_uuid" in self.model_fields_set:
            _dict['conference_call_user_uuid'] = None
        ...
        # set to None if conference_call_users_role (nullable) is None
        # and model_fields_set contains the field
        if self.conference_call_users_role is None and "conference_call_users_role" in self.model_fields_set:
            _dict['conference_call_users_role'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConferenceCall from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "bump_params": BumpParams.from_dict(obj["bump_params"]) if obj.get("bump_params") is not None else None,
            "call_type": obj.get("call_type"),
            "conference_call_user_uuid": obj.get("conference_call_user_uuid"),
            "conference_call_users": [User.from_dict(_item) for _item in obj["conference_call_users"]] if obj.get("conference_call_users") is not None else None,
            "conference_call_users_role": [ModelConferenceCallUserRole.from_dict(_item) for _item in obj["conference_call_users_role"]] if obj.get("conference_call_users_role") is not None else None,
